...
//4thsc
@Then("add first test {int} {int}")
public void add_first_test(Integer int1, Integer int2) {
   
}

@Then("add second test {int} {int}")
public void add_second_test(Integer int1, Integer int2) {
