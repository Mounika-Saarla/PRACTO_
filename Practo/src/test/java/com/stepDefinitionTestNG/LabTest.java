...
public class LabTest extends BaseSteps {
   ...
   //6thsc
	@Then("click on Enter Patient Name")
	public void click_on_enter_patient_name() throws InterruptedException {
	    homepage.clickPName();
	}

	
	@Then("Enter Patient Name")
	public void enter_patient_name() throws InterruptedException {
	    homepage.enterPName();
	}

	@Then("verify the Patient Name")
	public void verify_the_patient_name() throws InterruptedException {
	    homepage.verifyPName();
	}
