...
import com.setup.Reports.ExtentManager;
...
public class Profile {
	...
	public void when_the_user_launches_practo_home_page() {
	    driver = BaseSteps.getDriver();
	    test = ExtentManager.getExtent().createTest("Negative Scenario - Invalid Doctor Search");
	    userPage = new UserPage(driver, test);
	    userPage.openHomePage(PropertyReader.getProperty("AppUrl"));
	}
	...
	public void user_clicks_on_the_search_bar() {
	    userPage.clickSearchBar();
	}

	@When("user enters an invalid doctor name")
	public void user_enters_an_invalid_doctor_name() {
	    String invalidDoctor = PropertyReader.getProperty("InvalidDoctorName");
	    userPage.enterInvalidDoctorName(invalidDoctor);
	}

	@When("user selects a suggestion from dropdown")
	public void user_selects_a_suggestion_from_dropdown() {
	    userPage.selectFirstSuggestion();
	}


	@When("user clicks on the Search button")
	public void user_clicks_on_the_search_button() {
	    userPage.triggerSearch(); // ✅ Press Enter
	}

	@Then("user should see a message No results found on the page")
	public void user_should_see_a_message_no_results_found_on_the_page() {
	    String expectedMessage = PropertyReader.getProperty("ExpectedNoResultsMessage");
	    Assert.assertTrue(userPage.validateNoResultsMessage(expectedMessage),
	            "Validation failed for No results message");
	}
}