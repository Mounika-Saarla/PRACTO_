...
public class Profile extends BaseSteps {
	...
	public void filtered_clinic_results_should_be_displayed() {
		...
		Reports.captureScreenshot(driver, "location");
	}
	...
	public void user_select_the_doctor_in_that_clinic() {
		...
		Reports.captureScreenshot(driver, "doctor");
	}
	...
	public void user_click_on_call_clinic() {
		...
		Reports.captureScreenshot(driver, "Gopalapuram");
	}
...
///
		Reports.captureScreenshot(driver, "QureOrtho");
...
//		WebElement hospitalInput = driver.findElement(By.xpath("//*[@id=\"c-omni-container\"]/div/div[2]/div[1]/input"));
		userPage.specialityfilter(hospitalName);
//		hospitalInput.click();
//		hospitalInput.clear();
//		hospitalInput.sendKeys(hospitalName);
//		hospitalInput.sendKeys(Keys.ARROW_DOWN);
//		hospitalInput.sendKeys(Keys.ENTER);
		Reports.captureScreenshot(driver, "speciality");
	}
//--------------------------------scenario 6(@negative)---------------------
	@And("User applies a location1 filter from sheet {int} at RowIndex {int}")
	public void user_applies_a_location1_filter_from_sheet_at_row_index(Integer sheetIndex, Integer rowIndex) throws Exception {
		String location1 = reader.getCellData(sheetIndex, rowIndex, 0);
		page.applylocationFilter(location1);
		System.out.println("Applied Location filter: " + location1);
	}
