...
//	private WebElement searchButton;
    ...
    @FindBy(xpath = "//button[contains(text(),'Search')]") // Adjust if your search button differs
...
//------------------4th Scenario--------------------
	...
	public void searchMedicine(String medicineName) {
	    searchBar.clear();
	    searchBar.click();
	    searchBar.sendKeys(medicineName);
	    searchBar.sendKeys(Keys.ENTER); // or click search button
	}
